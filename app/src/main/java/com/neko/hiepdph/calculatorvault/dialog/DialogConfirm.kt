...
enum class DialogConfirmType(
    ...
    DELETE(R.string.delete,R.string.delete_instruction,R.drawable.ic_delete,R.string.cancel,R.string.yes),
    UNLOCK(R.string.unlock,R.string.unlock_instruction),
...
class DeleteConfirmDialog(
    private val callBack: ConfirmDialogCallBack, private val content: String? = null
) : DialogFragment() {
    ...
    private fun initView() {
        if (content != null) {
            binding.tvInstruction.text = content
        }
        initButton()
    }
